...
function InitImages () {
    imageList = [
    assets.image`Ender perl`,
    assets.image`Poción de veneno 2`,
    assets.image`Piensa`,
    assets.image`Ya lo sabes`,
    assets.image`Cuando te tiras un pedo`,
    assets.image`Cuando es la 3674637 vez que lo explica y no lo entiendes`
    ]
}
...
let index = 0
let value = 0
game.showLongText("Memoriza los memes", DialogLayout.Bottom)
